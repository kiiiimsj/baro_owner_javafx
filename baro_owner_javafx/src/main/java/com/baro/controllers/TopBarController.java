...
public class TopBarController extends Application {
    double initialX;
    double initialY;
    @Override
    ...
    public void start(final Stage stage) throws Exception {
        ...
        scene.getStylesheets().add(getResource("/css/clock.css"));
    ...
    static String getResource(String path) {
        return TopBarController.class.getResource(path).toExternalForm();
    }
