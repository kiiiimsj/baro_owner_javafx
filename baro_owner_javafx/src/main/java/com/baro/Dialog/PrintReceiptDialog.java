...
public class PrintReceiptDialog implements Initializable {
    ...
    public void call(ButtonClick buttonClick){
        ...
        try {
            ...
            printReceiptDialog.buttonClick = buttonClick;

            stage.initModality(Modality.APPLICATION_MODAL);
            stage.setResizable(false);
            stage.setScene(scene);
            printReceiptDialog.configureBottom();
    ...
    public void configureBottom() {
        dialog_content.setText("영수증을 출력하시겠습니까?");
